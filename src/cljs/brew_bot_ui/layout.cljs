(ns brew-bot-ui.layout
  (:require [antizer.reagent :as ant]
            [brew-bot-ui.recipe-generation.views :as recipe-generator]
            [brew-bot-ui.recipes.views :as recipes]
            [brew-bot-ui.text-pages.static-content :as static]
            [brew-bot-ui.visual-identity.colors :as colors]
            [reagent.core :as r]
            [re-frame.core :as rf]))
     ...
     (r/as-element
      [ant/row
       ...
       [ant/col {:span 1 :offset 11}
        [:a {:href "https://github.com/nnichols/brew-bot-ui" :target "_blank"}
      ...
      [ant/row {:style {:align "bottom" :text-align "center" :color colors/dim-gray}}
       [ant/col
        [:p {:style {:font-size "10pt"}}
         [:a {:href "https://github.com/nnichols/brew-bot-ui/issues" :target "_blank"}
